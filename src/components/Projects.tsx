...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      year: '2025',
      description: 'Open-source hardware hacking tool inspired by Flipper Zero, built in C++. Implements RF signal capture/replay, RFID reader, IR transmitter, and GPIO interaction on a compact embedded platform.',
      category: 'embedded',
      technologies: ['C++', 'RFID', 'IR Blaster', 'RF 433MHz', 'GPIO', 'Embedded Security'],
      icon: Shield,
      accentColor: '#f97316',
